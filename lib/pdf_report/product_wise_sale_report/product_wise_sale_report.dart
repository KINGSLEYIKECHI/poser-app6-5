...
Future<void> generateProductSaleReport(
  ...
  try {
          ...
          return pw.Center(
            child: pw.Column(
              ...
              children: [
                ...
                localizedText(
                  _lang.productWiseSale, // Localized "Product Wise Sale Report"
                  size: 16,
                  bold: true,
                  alignment: pw.TextAlign.center,
                ),
        ...
        build: (pw.Context context) {
          ...
          for (int i = 0; i < data.length; i++) {
            ...
            tableData.add([
              ...
              localizedText(DateFormat('dd-MM-yyyy').format(DateTime.parse(data[i].saleDate.toString())),
                  alignment: pw.TextAlign.center),
          ...
          final headers = [
            ...
            localizedText(_lang.customer, bold: true, color: PdfColors.white, alignment: pw.TextAlign.center),
    ...
    final file = File('${dir.path}/${appsName}-sale-report.pdf');
