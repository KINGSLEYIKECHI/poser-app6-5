      ...
      builder: (context, ref, __) {
        ...
        return GlobalPopup(
          child: Scaffold(
            ...
            appBar: AppBar(
              title: Text(l.S.of(context).purchaseReport),
              actions: [
                personalData.when(
                  data: (business) {
                              ...
                              filteredTransactions.isNotEmpty
                                  ? ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        final purchase = filteredTransactions[index];
                                        final taxAsync = ref.watch(purchaseTaxProvider(purchase.id!.toInt()));

                                        final num totalAmt = purchase.totalAmount ?? 0;
                                        final num dueAmt = purchase.dueAmount ?? 0;
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        if (dueAmt.toInt() != 0)
                                                          Text(
                                                            '${l.S.of(context).due}: $currency${formatPointNumber(dueAmt)}',
                                                            style: _theme.textTheme.titleSmall?.copyWith(
                                                              fontWeight: FontWeight.w500,
                                                            ),
                                                          ),
                                                                  ...
                                                                  onPressed: () async {
                                                                    if (Theme.of(context).platform ==
                                                                      ...
                                                                      PrintPurchaseTransactionModel model =
                                                                        ...
                                                                        purchaseTransitionModel: purchase,
