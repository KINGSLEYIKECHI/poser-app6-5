...
import '../Sign In/webview_login.dart';
                            ...
                            if (result is bool && result) {
                              if (result) {
                                if (await checkEmailForCodePupUp(
                                    email: emailTextController.text, context: context, textTheme: textTheme)) {
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: OutlinedButton.icon(
                                      onPressed: () {
                                        print('${APIConfig.domain}login/twitter?platform=app');
                                        ...
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) => WebViewLogin(
                                              loginUrl: "${APIConfig.domain}login/twitter?platform=app",
                                            ),
                                          ),
                                        );
                                      },
                                  ...
                                  Expanded(
                                    child: OutlinedButton.icon(
                                      onPressed: () {
                                        print("${APIConfig.domain}login/google?platform=app");
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => WebViewLogin(
